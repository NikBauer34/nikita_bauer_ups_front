'use client'
import { EnterButton, GoBackButton, SecondaryParagraph, SecondaryTitle } from "@/shared";
  ...
  return (
    ...
    <div className="common-container ">
      <div className="flex flex-col items-start justify-center">
        ...
        <EnterButton text="Вернуться к “Счета и депозит”" className="mt-[110px] invisible md:visible w-full" onClick={() => router.push('/')}></EnterButton>
      </div>
      </div>
      </div>
      </div>
